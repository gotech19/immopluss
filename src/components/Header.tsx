    ...
    <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors shadow-xs">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          {/* Favorites Button (hidden on phone, available in bottom nav) */}
          <button
            id="nav-favorites-btn"
            onClick={() => handleNav('favorites')}
            title={t('navFavorites')}
            className="hidden sm:flex relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:text-[#0B3D91] dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
          >
          ...
          {/* Messages Button (hidden on phone, available in bottom nav) */}
          <button
            id="nav-messages-btn"
            onClick={() => {
              if (!userProfile) {
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2 sm:p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:text-[#0B3D91] dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
            >
            ...
            {notifDropdownOpen && (
              <div className="absolute right-0 rtl:right-auto rtl:left-0 mt-2 w-72 sm:w-80 max-w-[calc(100vw-1.5rem)] bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 py-2 z-50">
          ...
          <button
            ...
            className="lg:hidden p-2 min-w-[40px] min-h-[40px] flex items-center justify-center rounded-xl text-slate-600 dark:text-slate-300 hover:text-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer active:scale-95 transition-all"
            aria-label="Menu"
          >

...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#0B3D91] via-[#093278] to-[#062456] text-white py-8 sm:py-16 lg:py-20 px-3.5 sm:px-6 lg:px-8 overflow-hidden shadow-inner">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        {/* Brand Slogan Pill */}
        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[#FBBF24] text-[11px] sm:text-xs font-bold tracking-wider mb-3 sm:mb-5 shadow-sm">
          <span>{t('slogan')}</span>
        ...
        {/* Hero Title */}
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white mb-2 sm:mb-3 leading-tight drop-shadow-sm">
          {t('heroTitle')}
        </h1>
        <p className="text-xs sm:text-base lg:text-xl text-blue-100 max-w-2xl mx-auto mb-5 sm:mb-8 font-medium leading-relaxed">
          {t('heroSubtitle')}
        </p>

        {/* Main Search Box Card */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 sm:p-6 shadow-2xl border border-slate-100 dark:border-slate-800 text-slate-900 dark:text-white text-left">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 mb-3 sm:mb-4 overflow-x-auto pb-1 scrollbar-none">
            <button
              ...
              className={`flex-1 sm:flex-none text-center px-3 sm:px-4 py-2 text-[11px] sm:text-xs uppercase tracking-wider font-bold rounded-xl transition-all whitespace-nowrap cursor-pointer ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-2.5 sm:gap-3 items-center">
              ...
              <div className="sm:col-span-2 lg:col-span-2 flex items-center gap-2">
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl bg-[#FBBF24] hover:bg-[#F59E0B] text-slate-950 font-extrabold text-xs uppercase tracking-wider shadow-md flex items-center justify-center gap-2 active:scale-95 transition-all cursor-pointer min-h-[44px]"
                >
